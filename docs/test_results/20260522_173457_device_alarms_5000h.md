...
- tool[1] search_devices args={'data_center_id': 1, 'device_nm': 'CRAC-6F A-101-17'}
  → output_len=N/A, preview: [{'type': 'text', 'text': '[{"device_id":1499,"device_name":"CRAC-6F A-101-17","device_category_name":"HVAC","device_type_name":"CRAC","location":"06F > 6층 서버실 A (서측-W) > A1","enable_monitor":1,"manufacturer_name":"삼화에이스","connected_ups":null}]', 'id': 'lc_61b461e8-81d7-41f0-b220-212585636f17'}]
